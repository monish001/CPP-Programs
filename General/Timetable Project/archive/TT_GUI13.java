...
//		TTPanel.setLayout(new GridLayout(4,1));
		...
		page1rowTypeA Trow = new page1rowTypeA(mainPanel, "batch", myFrame.initialOptions("batch"), 25);

		page1rowTypeA Crow = new page1rowTypeA(mainPanel, "course", myFrame.initialOptions("course"), 60);

		page1rowTypeA Grow = new page1rowTypeA(mainPanel, "room", myFrame.initialOptions("room"), 95);

		page1rowTypeA Rrow = new page1rowTypeA(mainPanel, "teacher", myFrame.initialOptions("teacher"), 130);
...
class page1rowTypeA implements ActionListener{
	...
	static void addRadioButton(final String tableName, String label)
	{
		...
		/*ActionListener listener = new ActionListener()
		{
			...
			{
				//TT1 Page2;
				//Page2 = new TT1(tableName);
				myFrame2 page2 = new myFrame2(tableName);
				//this.dispose();
			}
		};*/
	...
	JComboBox myCBox;
	static JButton btnHead = new JButton("Welcome to TimeTable Page1");
	String tName;
