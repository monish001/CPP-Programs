...
class page1rowTypeA implements ActionListener{
	...
	static JRadioButton t = new JRadioButton("Teachers",true);
	static JRadioButton r = new JRadioButton("Rooms");
	static JRadioButton b = new JRadioButton("Batches");
	JComboBox myCBox;
