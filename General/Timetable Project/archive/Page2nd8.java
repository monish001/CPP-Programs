...
public class Page2nd extends JFrame// implements ActionListener
{
	...
	Page2nd()
	{
		...
		{
			System.out.println("line 64"+npe.toString());
			bCBox = new JComboBox();
		}
...
class ParticularTT
{
	ParticularTT(String tableName, String idName) throws SQLException//constructor
	{
		...
		for(int p=1; p<=9; p++)
		{
			...
			pTTPanel.add(outerInnerBoxPanel[p-1][d-1]);
		}
	}
			...
			public void actionPerformed(ActionEvent event)
			{
				if(((box.CBox1).getSelectedIndex() != 0) && ((box.CBox2).getSelectedIndex() != 0) && ((box.CBox3).getSelectedIndex() != 0))
				{
					...
					try
					{
						...
						stmt.executeUpdate(qry);
						(Page2nd.btnFoot).setText("You can now enter the new values..");
					}
					catch(SQLException err)
					{
	...
	public final ResultSet isEntrySaved(int d, int p, String tableName, String idName, String[] tableNames)// throws SQLException
	{
       	ResultSet rset;
	...
	JPanel pTTPanel;
	final JPanel[][] outerInnerBoxPanel;
	static JdbcConnection con;
	static Connection c=null;
	static Statement stmt=null; 
	static ResultSet rset = null;
	{
		outerInnerBoxPanel = new JPanel[9][5];
	}
}
