...
//1.)MenuBar
//2.)shows a model dailog to enter the schema user n pass & a new file with some extension,
//say myTT.tt, now all 5 tables names with prefixed by myTT phrase in the schema mentioned.
...
class page1rowTypeA implements ActionListener{
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		if(btnLabel == "Insert")
		{
			...
			if((!itemToInsert.equals("Insert "+tName+":")) && (!itemToInsert.equals("")) && (!(itemToInsert.charAt(0)=='-')))
			{
